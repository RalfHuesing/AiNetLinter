...
Completed At: 2026-06-14T11:20:00+02:00
...
| [09 (Erledigt)](09-P2-EnforceNamespaceDirectoryMapping-FeatureFolder.md) | **P2** | `EnforceNamespaceDirectoryMapping` | `NamespaceDirectoryMappingMode` + `IgnorePathSegments` + `RequiredTrailingSegments` |
| [10 (Erledigt)](10-P3-StaticTestSentinel-ExemptSuffixes.md) | **P3** | `StaticTestSentinel` | `ExemptClassNameSuffixes` + `ExemptWhenInheritsFrom` + `ExemptStaticClasses` in TestSentinelConfig; `ClassInfo` um `IsStatic` + `BaseTypeNames` erweitern |
| [11 (Erledigt)](11-P3-EnforceResultPattern-AllowThrowIn.md) | **P3** | `EnforceResultPatternOverExceptions` | `ResultPatternAllowThrowInNamespaceSuffixes` + `ResultPatternAllowCatchRethrow` |
| [12 (Erledigt)](12-Cross-README-Integrationsleitfaden.md) | Cross | README + Profil-Vorlagen | Vollständige README-Überarbeitung; WPF- und Blazor-Profil-Templates |
