...
3. **Zwei aktive Bugs** (Playbook-Werte falsch, Records fehlen in Statistiken)
...
| **3**   | F10 (RunAsync)                                                          | Struktur   |

> **✅ F3 (Command-Klassen) wurde abgeschlossen:** `Program.cs` ist auf ~80 LOC reduziert, alle 8 Sub-Befehle sind in `src/AiNetLinter/Commands/` ausgelagert.
...
| `Program.cs` LOC                    | ~~568~~ → **80**   | ✅ Commands/ Verzeichnis mit 8 Klassen     |
