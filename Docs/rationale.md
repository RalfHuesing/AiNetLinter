...
*   **Referenz:** Bug-Report gegen ein externes, per MCP gelintetes Projekt (nicht restored, `dotnet build` lief dort fehlerfrei) — `safeguard`-Score fiel auf 0,00/10 durch tausende Phantom-Folgefehler statt einer einzigen, actionable Diagnose.
