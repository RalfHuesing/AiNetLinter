...
```json
{
  "Global": {
    ...
    "SkeletonDependencySuffixes": ["Repository", "Service", "Handler", "Client", "Gateway", "Manager", "Sender", "Factory", "Provider", "Logger", "Writer", "Reader"],
    "AllowDynamic": false,
...
| `SkeletonDependencySuffixes`                     | Global  | Suffixe für Typen, die bei der Generierung der Skeleton Map als Service-Abhängigkeiten klassifiziert werden (Standard: `["Repository", "Service", "Handler", "Client", "Gateway", "Manager", "Sender", "Factory", "Provider", "Logger", "Writer", "Reader"]`). |
...
- **`SkeletonDependencySuffixes`** (Array von Strings): Suffixe für Klassen- und Typnamen, die bei der Generierung einer Skeleton Map als Service-Abhängigkeiten deklariert werden (z. B. `"Repository"`, `"Service"`). Standardmäßig sind dies: `["Repository", "Service", "Handler", "Client", "Gateway", "Manager", "Sender", "Factory", "Provider", "Logger", "Writer", "Reader"]`. Falls eine Methode auf ein privates Feld/Eigenschaft zugreift, deren Typ auf eines dieser Suffixe endet (oder ein C#-Interface ist), wird sie im `Uses:` Kommentar der Methode aufgeführt.
