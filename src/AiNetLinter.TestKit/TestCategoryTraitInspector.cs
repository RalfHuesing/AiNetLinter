...
{
    public static List<Type> GetTestClasses(Assembly assembly) => assembly.GetTypes()
    ...
    public static List<string> GetCategoryTraits(Type type) => type.GetCustomAttributes()
