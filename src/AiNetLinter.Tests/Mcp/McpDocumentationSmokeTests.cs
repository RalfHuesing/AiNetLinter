...
public sealed class McpDocumentationSmokeTests
{
    ...
    {
        // Erwartung: Docs/agent-api.md#mcp-server-modus nennt 10 C#-only-Tools (inkl. get_call_tree
        // und pattern_detect, seit deren Einfuehrung in S1.4/S2.2) und hebt search_pattern als
        ...
        //
        // A3-Pfad: Doku enthaelt "9 Tools sind C#-only" (Stand vor pattern_detect) ->
        // Assert.DoesNotContain("9 Tools") wird rot. Doku enthaelt "10 Tools sind C#-only" ->
        ...
        Assert.Contains("10 Tools sind C#-only", docText, System.StringComparison.Ordinal);
