...
public sealed class McpServerCommandTests : IClassFixture<BaselineMcpFixture>
{
    ...
    public async Task RunAsync_ValidFixture_ServerRespondsWithFifteenTools()
    {
        ...
        [
            "find_symbol", "find_references", "get_impact", "get_file_skeleton", "get_type_hierarchy",
            "get_index_scope", "get_hotspots", "get_violations", "safeguard", "search_pattern",
            "get_symbol_body", "reload_config", "get_server_health", "metrics_tree", "pattern_detect",
        ];
