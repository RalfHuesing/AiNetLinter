...
/// <summary>
/// Startet einmalig pro Collection den MCP-Server-Prozess gegen das echte Repository (AiNetLinter.slnx).
/// Wird in Read-Only Integrationstests via <c>[Collection("McpLiveRepository")]</c> geteilt verwendet.
/// </summary>
