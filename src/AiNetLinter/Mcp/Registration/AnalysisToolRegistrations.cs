        ...
        ProjectRegistry registry)
    {
        tools.Add(McpServerTool.Create(
            ...
            TargetPathToolRegistrationOptions.SourceReadOnlyTool(
                ...
                "Fester Source-Quality-Gate: pass nur bei Score 10.0 und 0 Lint-Verstößen. scope: changes (Default) oder solution. Bei operation=running denselben Aufruf mit operationToken fortsetzen; das endgültige Gate-Ergebnis bleibt unverändert. Dead-Code-Advisories in beiden Scopes, Referenzen solutionweit; changes berücksichtigt bisherige Ziele entfernter Nutzungen. Zusätzliches Budget 10 Sekunden, bei explizitem solution 60 Sekunden inklusive Vorbereitung. Standardcontent höchstens 8 KiB und 20 Gruppen; partielle Scanabdeckung und Ausgabekürzung getrennt interpretieren. Kandidaten sind keine Löschfreigabe.")));
    }
