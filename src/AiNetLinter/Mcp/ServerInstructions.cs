...
internal static class ServerInstructions
{
    ...
    internal const string Text =
        ...
        "Der Content enthält Status, Vollständigkeit und Handoff-IDs für Folgeaufrufe. Bei Budgetfehler denselben Aufruf mit maxResponseBytes=minimumResponseBytes wiederholen; includeReferences erweitert Assembly-Suche nur explizit.\n\n" +
