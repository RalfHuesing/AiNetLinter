...
internal static class CliCommandBuilder
{
    internal static (RootCommand Root, CliOptions Options) Build()
    {
        ...
        var root = new RootCommand("AiNetLinter - CLI-Linter für AI-optimierten .NET Code")
        {
            ...
            options.Fix, options.Impact, options.SyncCursorRules, options.SyncCursorRulesOnly, options.CursorRulesPath, options.Check, options.NoCache, options.CacheTtl,
    ...
    private static CliOptions CreateOptions()
    {
        return new CliOptions(
            ...
            CliOptionFactory.CreateSyncCursorRulesOnlyOption(),
            CliOptionFactory.CreateCursorRulesPathOption(),
    ...
    internal static CliParsedArgs Parse(ParseResult parseResult, CliOptions options)
    {
        return new CliParsedArgs(
            ...
            SyncCursorRulesOnly: parseResult.GetValue(options.SyncCursorRulesOnly),
            CursorRulesPath: parseResult.GetValue(options.CursorRulesPath),
