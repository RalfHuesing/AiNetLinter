...
<#
.SYNOPSIS
    Fuehrt FastTests fuer AiNetLinter aus und schreibt das Ergebnis statisch nach TestResults/FastTests.trx.
...
$projectPath = Join-Path $repoRoot 'src/AiNetLinter.FastTests'
