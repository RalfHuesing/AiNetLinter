...
- Status: in_progress (Folge-Review 3: ein P1 offen)
...
- current_epic: Epic 1 Korrekturrunde 4
- letzter Commit: `55dbaa4b` (Korrektur-Checkpoint 3); Review-Checkpoint folgt
