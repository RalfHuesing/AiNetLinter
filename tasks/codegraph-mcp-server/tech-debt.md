...
| TD-019 | `src/AiNetLinter.Tests/Fixtures/SymbolGraphMcpFixture.cs` (parallele Test-Init) | niedrig | MCP-Server-Init-Timeout bei 16 parallelen Test-Collections im ersten Volllauf von 010 (Re-Run in 1s grün, **kein 010-Regress**). Pre-existing Race-Condition in `StdioClientTransport`-Startphase. **Erkannt im Review von Einheit 010** (Kritiker-Vorschlag). |
