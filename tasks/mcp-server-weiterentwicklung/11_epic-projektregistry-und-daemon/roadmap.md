...
- [x] **EPIC-A: Projektregistry (transportneutral)** — Der MCP-Server hält mehrere
      ...
      Live-Verifikation Overview, Meilenstein-Doku, §D.4) ist in step-008
      approved abgeschlossen. EPIC-A ist damit vollständig erledigt;
      EPIC-B wird jetzt JIT geplant.
  ...
  - [ ] A.x Doku-Sammelpflichten (im fachlich berührenden Step, keine Mini-Doku-Steps):
        ...
        step-008 (EPIC-A abgeschlossen))

  - **Step-008-Abschluss (2026-08-24):** Die EPIC-A-Fachlichkeit sowie die
