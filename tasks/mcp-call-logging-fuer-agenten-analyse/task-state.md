...
last_updated: 2026-08-05T13:00:00+02:00
...
|------|------|--------|-------|------------|-------|----------|--------|
| step-001 | EPIC-01 | done | Default-Pfad-Konvention + harter Error-Exit bei fehlender Solution (kein Fallback) | 0/3 | 1cefdce0 | f66eabad | e01b52c |
