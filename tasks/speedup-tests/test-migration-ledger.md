...
| `src/AiNetLinter.Tests/Core/Checkers/AsciiIdentifiersTests.cs` | `AsciiIdentifiersTests` | Checkers | pending | `FullyQualifiedName~AsciiIdentifiersTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/AsyncVoidCheckerTests.cs` | `AsyncVoidCheckerTests` | Checkers | pending | `FullyQualifiedName~AsyncVoidCheckerTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/BlockingTaskCheckerTests.cs` | `BlockingTaskCheckerTests` | Checkers | pending | `FullyQualifiedName~BlockingTaskCheckerTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/CouplingSemanticTests.cs` | `CouplingSemanticTests` | Checkers | pending | `FullyQualifiedName~CouplingSemanticTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/DuplicateCodeCheckerTests.cs` | `DuplicateCodeCheckerTests` | Checkers | pending | `FullyQualifiedName~DuplicateCodeCheckerTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/DynamicTypeCheckerTests.cs` | `DynamicTypeCheckerTests` | Checkers | pending | `FullyQualifiedName~DynamicTypeCheckerTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/LinqChainLengthCheckerTests.cs` | `LinqChainLengthCheckerTests` | Checkers | pending | `FullyQualifiedName~LinqChainLengthCheckerTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/MaxBoolParameterCountTests.cs` | `MaxBoolParameterCountTests` | Checkers | pending | `FullyQualifiedName~MaxBoolParameterCountTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/MaxConstructorDependenciesTests.cs` | `MaxConstructorDependenciesTests` | Checkers | pending | `FullyQualifiedName~MaxConstructorDependenciesTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/MaxInheritanceDepthTests.cs` | `MaxInheritanceDepthTests` | Checkers | pending | `FullyQualifiedName~MaxInheritanceDepthTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/MaxPartialClassFilesTests.cs` | `MaxPartialClassFilesTests` | Checkers | pending | `FullyQualifiedName~MaxPartialClassFilesTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/MaxPublicMembersPerTypeTests.cs` | `MaxPublicMembersPerTypeTests` | Checkers | pending | `FullyQualifiedName~MaxPublicMembersPerTypeTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/MaxSwitchArmsTests.cs` | `MaxSwitchArmsTests` | Checkers | pending | `FullyQualifiedName~MaxSwitchArmsTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/MethodParameterCountAccessibilityTests.cs` | `MethodParameterCountAccessibilityTests` | Checkers | pending | `FullyQualifiedName~MethodParameterCountAccessibilityTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/MethodParameterCountIgnoreTypePrefixesTests.cs` | `MethodParameterCountIgnoreTypePrefixesTests` | Checkers | pending | `FullyQualifiedName~MethodParameterCountIgnoreTypePrefixesTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/MethodParameterCountOverrideTests.cs` | `MethodParameterCountOverrideTests` | Checkers | pending | `FullyQualifiedName~MethodParameterCountOverrideTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/MiddleManCheckerTests.cs` | `MiddleManCheckerTests` | Checkers | pending | `FullyQualifiedName~MiddleManCheckerTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/NamespaceCouplingCheckerTests.cs` | `NamespaceCouplingCheckerTests` | Checkers | pending | `FullyQualifiedName~NamespaceCouplingCheckerTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/NamespaceDirectoryMappingTests.cs` | `NamespaceDirectoryMappingTests` | Checkers | pending | `FullyQualifiedName~NamespaceDirectoryMappingTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/NamingCheckerTests.cs` | `NamingCheckerTests` | Checkers | pending | `FullyQualifiedName~NamingCheckerTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/NestedTypesCheckerTests.cs` | `NestedTypesCheckerTests` | Checkers | pending | `FullyQualifiedName~NestedTypesCheckerTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/PhantomDependencyCheckerTests.cs` | `PhantomDependencyCheckerTests` | Checkers | pending | `FullyQualifiedName~PhantomDependencyCheckerTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/SealedClassCheckerTests.cs` | `SealedClassCheckerTests` | Checkers | pending | `FullyQualifiedName~SealedClassCheckerTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/SilentCatchAllowedTypesTests.cs` | `SilentCatchAllowedTypesTests` | Checkers | pending | `FullyQualifiedName~SilentCatchAllowedTypesTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/SwitchDispatcherDetectorTests.cs` | `SwitchDispatcherDetectorTests` | Checkers | pending | `FullyQualifiedName~SwitchDispatcherDetectorTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/UiFileSeparationCheckerTests.cs` | `UiFileSeparationCheckerTests` | Checkers | pending | `FullyQualifiedName~UiFileSeparationCheckerTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/ValueObjectCheckerTests.cs` | `ValueObjectCheckerTests` | Checkers | pending | `FullyQualifiedName~ValueObjectCheckerTests` |  |
| `src/AiNetLinter.Tests/Core/Checkers/WpfCodeBehindTests.cs` | `WpfCodeBehindTests` | Checkers | pending | `FullyQualifiedName~WpfCodeBehindTests` |  |
...
| `src/AiNetLinter.Tests/Core/DuplicateDetection/DuplicateDetectionEngineFalsePositiveTests.cs`, `src/AiNetLinter.Tests/Core/DuplicateDetection/DuplicateDetectionEngineTests.cs` | `DuplicateDetectionEngineTests` | DuplicateDetection | pending | `FullyQualifiedName~DuplicateDetectionEngineTests` |  |
| `src/AiNetLinter.Tests/Core/DuplicateDetection/RefactoringDriftEngineTests.cs` | `RefactoringDriftEngineTests` | DuplicateDetection | pending | `FullyQualifiedName~RefactoringDriftEngineTests` |  |
