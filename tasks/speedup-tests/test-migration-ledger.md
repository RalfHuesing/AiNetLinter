...
| `src/AiNetLinter.Tests/Baseline/SourceFileCatalogRegisterMSBuildTests.cs` | `SourceFileCatalogRegisterMSBuildTests` | Baseline | migrated | `FullyQualifiedName~SourceFileCatalogRegisterMSBuildTests` | `src/AiNetLinter.FastTests/Baseline/SourceFileCatalogRegistrationPolicyTests.cs` (1 Unit-Fall) + `src/AiNetLinter.IntegrationTests/Baseline/SourceFileCatalogRegistrationTests.cs` (1 Integration-Fall) + `src/AiNetLinter.IntegrationTests/Baseline/SourceFileCatalogRegistrationStressTests.cs` (1 Stress-Fall) |
...
| `src/AiNetLinter.Tests/Cli/CliCommandBuilderMcpLogTests.cs` | `CliCommandBuilderMcpLogTests` | Cli | migrated | `FullyQualifiedName~CliCommandBuilderMcpLogTests` | `src/AiNetLinter.FastTests/Cli/CliCommandBuilderMcpLogTests.cs` |
| `src/AiNetLinter.Tests/Cli/CliIntegrationTests.cs` | `CliIntegrationTests` | Cli | migrated | `FullyQualifiedName~CliIntegrationTests` | `src/AiNetLinter.IntegrationTests/Cli/CliRepositoryDogfoodTests.cs` (3 Dogfood-Fälle) + `src/AiNetLinter.IntegrationTests/Cli/CliFixtureIntegrationTests.cs` (4 Integration-Fälle); assertionloser DiagnosticDump konsolidiert |
...
| `src/AiNetLinter.Tests/Cli/ProgramTests.cs` | `ProgramTests` | Cli | migrated | `FullyQualifiedName~ProgramTests` | `src/AiNetLinter.FastTests/Cli/ProgramParsingTests.cs` (4 Unit-Fälle) + `src/AiNetLinter.IntegrationTests/Cli/ProgramAdapterTests.cs` (2 Integration-Fälle) |
| `src/AiNetLinter.Tests/Commands/AuditCommandTests.cs` | `AuditCommandTests` | Commands | migrated | `FullyQualifiedName~AuditCommandTests` | `src/AiNetLinter.IntegrationTests/Commands/AuditCommandTests.cs` |
| `src/AiNetLinter.Tests/Commands/CliBatchRegressionTests.cs` | `CliBatchRegressionTests` | Commands | migrated | `FullyQualifiedName~CliBatchRegressionTests` | `src/AiNetLinter.IntegrationTests/Commands/CliBatchRegressionTests.cs` |
| `src/AiNetLinter.Tests/Commands/DocsCommandTests.cs` | `DocsCommandTests` | Commands | migrated | `FullyQualifiedName~DocsCommandTests` | `src/AiNetLinter.IntegrationTests/Commands/DocsCommandTests.cs` |
| `src/AiNetLinter.Tests/Commands/ListRulesCommandTests.cs` | `ListRulesCommandTests` | Commands | migrated | `FullyQualifiedName~ListRulesCommandTests` | `src/AiNetLinter.FastTests/Commands/ListRulesCommandTests.cs` |
...
| `src/AiNetLinter.Tests/Commands/PlaybookCheckCommandTests.cs` | `PlaybookCheckCommandTests` | Commands | migrated | `FullyQualifiedName~PlaybookCheckCommandTests` | `src/AiNetLinter.IntegrationTests/Commands/PlaybookCheckCommandTests.cs` |
| `src/AiNetLinter.Tests/Commands/SyncAgentRulesCommandTests.cs` | `SyncAgentRulesCommandTests` | Commands | migrated | `FullyQualifiedName~SyncAgentRulesCommandTests` | `src/AiNetLinter.FastTests/Commands/SyncAgentRulesPolicyTests.cs` (11 Unit-Fälle) + `src/AiNetLinter.IntegrationTests/Commands/SyncAgentRulesFileIntegrationTests.cs` (2 Integration-Fälle) |
...
| `src/AiNetLinter.Tests/Fixtures/LoadFixtureBuilderTests.cs` | `LoadFixtureBuilderTests` | Fixtures | migrated | `FullyQualifiedName~LoadFixtureBuilderTests` | `src/AiNetLinter.IntegrationTests/Fixtures/LoadFixtureBuilderTests.cs` |
| `src/AiNetLinter.Tests/Fixtures/LoadFixtureMeasurementsTests.cs` | `LoadFixtureMeasurementsTests` | Fixtures | migrated | `FullyQualifiedName~LoadFixtureMeasurementsTests` | `src/AiNetLinter.IntegrationTests/Fixtures/LoadFixtureMeasurementsTests.cs` |
...
| `src/AiNetLinter.Tests/Mcp/McpDocumentationSmokeTests.cs` | `McpDocumentationSmokeTests` | Mcp | migrated | `FullyQualifiedName~McpDocumentationSmokeTests` | `src/AiNetLinter.IntegrationTests/Mcp/McpDocumentationSmokeTests.cs` |
| `src/AiNetLinter.Tests/Mcp/McpLiveRepositoryTests.cs` | `McpLiveRepositoryTests` | Mcp | migrated | `FullyQualifiedName~McpLiveRepositoryTests` | `src/AiNetLinter.IntegrationTests/Mcp/McpLiveRepositoryTests.cs` |
...
| `src/AiNetLinter.Tests/Mcp/McpTestClientParallelTests.cs` | `McpTestClientParallelTests` | Mcp | migrated | `FullyQualifiedName~McpTestClientParallelTests` | `src/AiNetLinter.IntegrationTests/Mcp/McpTestClientParallelTests.cs` |
