...
- **`src/AiNetLinter.Tests/Web/`** — Legacy-Quelle der fuenf reinen Unit-Testklassen fuer CSS-, JS- und Razor-Analyse sowie Web-Suppression; aktueller Parser-Teil von EPIC-3. (zuletzt: planning step-011)
...
- **`tasks/speedup-tests/test-migration-ledger.md`** — Inventar aller 183 Legacy-Testklassen mit Status, Legacy-Filter und neuem Abdeckungsort; die 28 Checker-Zeilen stehen auf `migrated`. (zuletzt: step-010)
