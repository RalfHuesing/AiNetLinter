...
- [ ] **EPIC-01: MarkdownBuilder-Foundation + Bug-Fix-Callsites umstellen** — Bündelt Konzept-Schritte 2 + 3 + 4 + 5 + 6 (Builder-Klasse anlegen, Testklasse anlegen, Callsites mit aktiven Escaping-Bugs umstellen). Konzept-Referenz: §2 (API), §3 Prio 1–3, §4 (Teststrategie), §8 Schritte 2–6.
...
- [ ] **EPIC-02: Verbleibende Callsites umstellen + HotspotSectionFormatter entfernen** — Bündelt Konzept-Schritte 7 + 8 + 9 + 10 + 11 + 12 (Hotspot-Cleanup + die sechs übrigen, seit Konzept-Stand neu hinzugekommenen oder übersehenen Callsites). Konzept-Referenz: §3 Prio 4–10, §5 Mängel-Liste, §8 Schritte 7–12.
