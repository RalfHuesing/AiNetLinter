...
current_step: step-011 (in_progress, Coder-Aufruf)
---
...
| step-011 | EPIC-06 | in_progress | Robuste `McpLintConsole` für stdout-Schutz (B.6) + E2E-JSON-RPC-Framing-Test (B.6) + Opt-in `--mcp-log` Call-Log (B.7) | 0/3 | (ausstehend) | (ausstehend) | (ausstehend) |
