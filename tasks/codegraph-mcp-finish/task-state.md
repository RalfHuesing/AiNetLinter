...
current_step: step-011 (in Planung, EPIC-06; vorausgegangen: step-010 done approved, EPIC-05 abgehakt)
---
...
| step-011 | EPIC-06 | in Planung | Robuste `McpLintConsole` für stdout-Schutz (B.6) + E2E-JSON-RPC-Framing-Test (B.6) + Opt-in `--mcp-log` Call-Log (B.7) | 0/3 | (ausstehend) | (ausstehend) | (ausstehend) |
