...
current_step: step-010 (open, EPIC-05 geplant, Last-Fixture + B.4-Kaltstart-Entkopplung + B.5-mtime-Cache + TD-005-Sanity-Fix + TD-007-Mitnahme)
---
...
- **Aktueller Schritt:** `step-010` (open, EPIC-05 geplant)
...
| step-010 | EPIC-05 | open | Last-Fixture + Skalierungsnachweis (B.3) + Kaltstart-Entkopplung (B.4) + mtime-Cache (B.5) + TD-005-Sanity-Fix + TD-007-Mitnahme | 0/3 | (pending) | (pending) | (pending) |
