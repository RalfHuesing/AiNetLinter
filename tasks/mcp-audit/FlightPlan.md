...
- [x] **Gruppe C: Semantische Symbol-Tools & Chaining-Ketten** (Tools 11–22) -> Bericht: [gruppe-c-symbol-chaining.md](gruppe-c-symbol-chaining.md) — 0 Critical, 5 Major, 1 Minor (C-01, C-02, C-04–C-07); CHAIN-01 und CHAIN-04 durchgängig, CHAIN-02–03 mit manuellem Parsing
...
- [x] **Abschlussbericht & Priorisierung** -> Bericht: [README.md](README.md) — 1 Critical, 10 Major, 5 Minor; Blocker E-01
