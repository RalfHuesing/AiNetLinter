...
- [x] **Gruppe C: Semantische Symbol-Tools & Chaining-Ketten** (Tools 11–22) -> Bericht: [gruppe-c-symbol-chaining.md](gruppe-c-symbol-chaining.md) — 0 Critical, 4 Major, 1 Minor (C-02, C-04–C-07); CHAIN-01, CHAIN-02 und CHAIN-04 durchgängig, CHAIN-03 mit manuellem Parsing
...
- [x] **Gruppe E: Cross-Tool-Konsistenz, Handoff-Vertrag & Recovery** (Querschnitt) -> Bericht: [gruppe-e-konsistenz-recovery.md](gruppe-e-konsistenz-recovery.md) — 1 Critical, 3 Major, 2 Minor (E-01, E-03–E-07); Blocker E-01
- [x] **Abschlussbericht & Priorisierung** -> Bericht: [README.md](README.md) — 1 Critical, 9 Major, 5 Minor; Blocker E-01
...
- [x] **TC-A04 (`get_server_health` auf `FALSE-01`)**: Negativfall (unmanaged Binary).
  - *Erwartung*: Saubere recoverable Diagnose, kein Prozessabsturz, kein interner Stacktrace.
- [x] **TC-A05 (`reload_config`)**: Konfigurations-Reload.
...
- [x] **TC-B01 (`get_index_scope` auf `SOURCE-01`)**: Indexabdeckung.
...
- [x] **CHAIN-01 (Symbol Deep-Dive Kette)**:
...
- [x] **CHAIN-02 (Klassen-Exploration zu Member-Body)**:
...
- [x] **CHAIN-03 (Typ-Hierarchie zu Implementierungen)**:
...
- [x] **CHAIN-04 (Assembly-Exploration zu Decompile-Stub)**:
...
- [x] **TC-E01 (Frühvalidierung & Envelope-Konsistenz)**:
...
- [x] **TC-E04 (Response-Budget & Deterministischer Retry)**:
...
- [x] **TC-E05 (Cross-Tool Parameter-Naming Konsistenz)**:
...
- [x] **TC-E06 (Session-Isolation bei Target-Wechsel)**:
