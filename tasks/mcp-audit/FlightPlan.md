...
- [x] **Gruppe B: Discovery, Scope & Assembly-Inspektion** (Tools 4–10) -> Bericht: [gruppe-b-discovery.md](gruppe-b-discovery.md) — 0 Critical, 2 Major, 0 Minor (B-05–B-06)
...
- [x] **Abschlussbericht & Priorisierung** -> Bericht: [README.md](README.md) — 1 Critical, 13 Major, 5 Minor; Blocker E-01
