...
- [x] EPIC-04: Testsuite & Integration-Verifikation — Unit- & Component-Tests in `AiNetLinter.FastTests` (Interface-Kaskadierung, Scope-Bounding, Whitelist-Sonderfälle, Filter-Kombinationen, Pagination) und Live-Dogfooding-Test in `AiNetLinter.IntegrationTests` (→ step-004).
