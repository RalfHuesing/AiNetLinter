...
- [ ] EPIC-02: Diagnosen & Locals-Erkennung (Mode-Support) — Integration von Compiler- und Roslyn-Diagnosen (`CS0169`, `CS0414`, `IDE0051`, `IDE0052`) für `mode: locals` / `both` (in Arbeit -> step-002).
