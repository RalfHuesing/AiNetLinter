...
last_updated: 2026-08-07T15:00:00+02:00
rules_dir: .agents/rules  # aus konzept.md Frontmatter übernommen
total_steps: 7  # Summe aller Steps inkl. Korrekturen — Basis für den weichen Deckel (siehe ../spec.md §10.5); step-007 done/approved
current_step: null  # kein Step aktiv; nächstes Planer-Aufruf im Step-Modus plant step-008
---
...
- **Aktueller Schritt:** `null` (zwischen Steps, letzter abgeschlossener
  war `step-007` EPIC-02 — done/approved, 0/3 Fix-Runden; nächster
  Schritt wird vom Planer im Step-Modus geplant — voraussichtlich
  `step-008`, `Output/`-Teil-2 (4 Klassen P–V))
