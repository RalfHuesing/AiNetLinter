...
- **`src/AiNetLinter.Tests/Web/`** — 5 Klassen (`CssAnalyzerTests`, `JsAnalyzerTests`, `RazorAnalyzerTests`, `WebSuppressionDetectorTests`); rein Unit, geplant für Batch „Reine-Unit-Ordner, klein" (zuletzt: step-002)
