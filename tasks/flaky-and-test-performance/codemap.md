...
last_updated: 2026-08-08T09:30:00+02:00
---
...
- **`src/AiNetLinter.Tests/Core/`** — 19 Klassen; rein Unit, mehrere Batches; step-011 nimmt erste 8 Klassen (A–`LinterEngineCacheTests`: `AutoFixerTests`, `ClassInfoCollectorTests`, `CompoundSuppressionEvaluatorTests`, `CompoundSuppressionIntegrationTests`, `ControlFlowResilienceTests`, `DiffImpactAnalyzerTests`, `LinterAnalyzerTests`, `LinterEngineCacheTests`; alle mit `[Trait("Category", "Unit")]` auf Klassen-Ebene versehen) als Mega-Batch-Anteil; step-012 verbleibend mit 11 Klassen (`LinterEngineTests`–`ViolationDescriptionTests`); **Schnitt-Annotation: 8 von 19 Klassen in step-011 done, 11 verbleibend in step-012 (LinterEngineTests bis ViolationDescriptionTests)** (zuletzt: step-011)
