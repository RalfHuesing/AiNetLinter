...
AiNetLinter kann auch als stdio-basierter MCP-Server gestartet werden, um die Roslyn-basierte Solution-Analyse als 9 granular abfragbare Tools für AI-Coding-Agenten bereitzustellen. Details und Registrierungs-Anleitung in [Docs/agent-api.md#mcp-server-modus](Docs/agent-api.md#mcp-server-modus) und [Docs/integration.md#mcp-server-registrieren](Docs/integration.md#mcp-server-registrieren).
