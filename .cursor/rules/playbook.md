...
- **src/AiNetLinter/**: 92 files, median Footprint 84 LOC, 7× disable-all
- **src/AiNetLinter.Tests/**: 70 files, median Footprint 148 LOC, 9× disable-all
