...
- **src/AiNetLinter/**: 131 files, median Footprint 73 LOC, 6× disable-all
- **src/AiNetLinter.Tests/**: 101 files, median Footprint 117 LOC, 12× disable-all
