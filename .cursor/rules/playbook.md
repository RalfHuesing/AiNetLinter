...
- **Kontrollfluss-Exceptions:** 33 `throw`-Anweisungen wurden im Code-Rumpf gefunden.
...
- **src/AiNetLinter/**: 150 files, median Footprint 76 LOC, 6× disable-all
