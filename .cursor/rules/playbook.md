...
Auto-generiert durch AiNetLinter 1.0.41 aus `C:\Daten\Entwicklung\Ralf\AiNetLinter\rules.json`.
...
- **src/AiNetLinter.Tests/**: 64 files, median Footprint 132 LOC, 9× disable-all
