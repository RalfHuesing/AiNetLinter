...
- **src/AiNetLinter/**: 91 files, median Footprint 81 LOC, 7× disable-all
- **src/AiNetLinter.Tests/**: 69 files, median Footprint 144 LOC, 9× disable-all
