...
Auto-generiert durch AiNetLinter 1.0.37 aus `C:\Daten\Entwicklung\Ralf\AiNetLinter\rules.json`.
...
- **Kontrollfluss-Exceptions:** 26 `throw`-Anweisungen wurden im Code-Rumpf gefunden.
