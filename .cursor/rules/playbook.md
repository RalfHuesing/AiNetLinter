...
Auto-generiert durch AiNetLinter 1.0.65 aus `C:\Daten\Entwicklung\Ralf\AiNetLinter\rules.json`.
...
- **src/AiNetLinter.Tests/**: 106 files, median Footprint 124 LOC, 12× disable-all
