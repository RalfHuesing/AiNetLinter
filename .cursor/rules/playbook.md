...
- **src/AiNetLinter/**: 113 files, median Footprint 65 LOC, 5× disable-all
- **src/AiNetLinter.Tests/**: 86 files, median Footprint 115 LOC, 9× disable-all
