...
Auto-generiert durch AiNetLinter 1.0.54 aus `C:\Daten\Entwicklung\Ralf\AiNetLinter\rules.json`.
...
- **src/AiNetLinter/**: 115 files, median Footprint 66 LOC, 5× disable-all
