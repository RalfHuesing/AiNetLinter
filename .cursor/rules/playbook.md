...
Auto-generiert durch AiNetLinter 1.0.43 aus `C:\Daten\Entwicklung\Ralf\AiNetLinter\rules.json`.
...
- **src/AiNetLinter.Tests/**: 65 files, median Footprint 132 LOC, 9× disable-all
