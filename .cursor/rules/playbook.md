...
Auto-generiert durch AiNetLinter 1.0.40 aus `C:\Daten\Entwicklung\Ralf\AiNetLinter\rules.json`.
...
- **src/AiNetLinter.Tests/**: 64 files, median Footprint 128 LOC, 9× disable-all
